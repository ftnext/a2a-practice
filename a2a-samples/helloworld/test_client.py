...
# Tweaked from https://github.com/a2aproject/a2a-samples/blob/3ac8e0b44446edede8f7ea398d48c758285f9eeb/samples/python/agents/helloworld/test_client.py
import logging
...
async def main() -> None:
    ...
    async with httpx.AsyncClient() as httpx_client:
        ...
        print("request:", request.model_dump(mode='json', exclude_none=True))
